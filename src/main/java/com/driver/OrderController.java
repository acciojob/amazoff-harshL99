...
public class OrderController {
    ...
    public ResponseEntity<Integer> getOrderCountByPartnerId(@PathVariable String partnerId){
        ...
        orderCount=orderService.noOfOrdersWithPartner(partnerId);
    ...
    public ResponseEntity<Integer> getOrdersLeftAfterGivenTimeByPartnerId(@PathVariable String time, @PathVariable String partnerId){
        ...
        countOfOrders=orderService.noOfOrdersLeftAfterTime(time, partnerId);
        return new ResponseEntity<>(countOfOrders, HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<String> getLastDeliveryTimeByPartnerId(@PathVariable String partnerId){
        ...
        time=orderService.lastOrderOfPartner(partnerId);
    ...
    public ResponseEntity<String> deleteOrderById(@PathVariable String orderId){
        ...
        orderService.deleteAndUnassignOrderFromPartner(orderId);
